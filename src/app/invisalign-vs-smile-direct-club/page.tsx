...
export default function InvisalignVsSmileDirectClub() {
  return (
    <div className="min-h-screen bg-white">
      <Header />

      <PageBanner 
        title="Smile Direct Club vs Your Local Dentist for Invisalign"
        subtitle=""
        description=""
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <p className="text-xl text-gray-600 mb-8">
              Smile Direct Club is a company that offers mail-order aligners for teeth straightening. While this may seem like a convenient and cost-effective option, there are several important reasons why choosing your local dentist for Invisalign treatment is the better choice.
            </p>
          </div>
          ...
          {/* Smile Direct Club Limitations Section */}
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            <h2 className="text-3xl font-bold text-[#004681] mb-6">The Limitations of Smile Direct Club</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Limited Professional Supervision</h3>
                <p className="text-gray-700 mb-4">
                  Smile Direct Club does not provide the same level of professional supervision as your local dentist. While they may have dentists on staff, you do not have the opportunity to meet with them in person or receive hands-on care throughout your treatment.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Smile Direct Club uses a one-size-fits-all approach to treatment planning. This means that your treatment plan may not be customized to your specific needs, which can lead to less than optimal results.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  If you experience any issues during your treatment, it can be difficult to get the support you need from Smile Direct Club. You may have to rely on online support or wait for responses to your questions.
                </p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            ...
            <p className="text-gray-700 mb-6">
              While Smile Direct Club may seem like a convenient and cost-effective option, choosing your local dentist for Invisalign treatment is the better choice. You will receive professional supervision, customized treatment, and better results.
            </p>
            <p className="text-gray-700 mb-6">
